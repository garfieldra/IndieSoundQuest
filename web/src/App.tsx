...
export function App() {
  ...
  const [mode, setMode] = useState<'popular' | 'explore'>('popular')
  ...
  return <main className="app-shell">
    ...
    {!tournament && <section className="panel setup">
      ...
      {mode === 'popular' ? <>
        ...
        <h2>把你的偏好写下来</h2>
        <label>从哪一种声音开始<textarea value={preferenceText} onChange={e => setPreferenceText(e.target.value)} placeholder="例如：克制、有叙事感的中文独立音乐，适合夜晚散步。" /></label>
