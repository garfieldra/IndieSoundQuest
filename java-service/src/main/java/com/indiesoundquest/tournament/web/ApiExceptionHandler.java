...
import com.indiesoundquest.redis.RateLimitExceededException;
...
@RestControllerAdvice public class ApiExceptionHandler {
 ...
 @ExceptionHandler(RateLimitExceededException.class) ResponseEntity<Map<String,Object>> rateLimited(RateLimitExceededException e){return error(HttpStatus.TOO_MANY_REQUESTS,"RATE_LIMIT_EXCEEDED",e.getMessage());}
